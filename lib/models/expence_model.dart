...
final Map<ExpenseCategory, Color> expenseCategoryColors = {
  ExpenseCategory.food: Color(0xFFE57373),
  ExpenseCategory.transport: Color(0xFF81C784),
  ExpenseCategory.health: Color(0xFF64B5F6),
  ExpenseCategory.shopping: Color(0xFFFFD54F),
  ExpenseCategory.subscription: Color(0xFF9575CD),
};
